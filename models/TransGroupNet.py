...
class TransNet_AP(nn.Module):
    def __init__(self, classes, dim=96):
        super(TransNet_AP, self).__init__()
        ...
        self.coder = Transformer(dim=dim, depth=32, heads=8, dim_head=dim // 8, mlp_dim=dim * 2, dropout=0.3)
